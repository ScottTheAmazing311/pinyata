...
const GAMES = [
  ...
  },
  {
    ...
    entries: [
      { primary_content: "Travel Adventures" },
      { primary_content: "Childhood Memories" },
      { primary_content: "Food & Eating Habits" },
      { primary_content: "Hidden Talents" },
      { primary_content: "Embarrassing Moments" },
      { primary_content: "Celebrity Encounters" },
      { primary_content: "School Days" },
      { primary_content: "Fears & Phobias" },
      { primary_content: "Jobs You've Had" },
      { primary_content: "Sports & Athletics" },
      { primary_content: "Music & Concerts" },
      { primary_content: "Family Stories" },
      { primary_content: "Late Night Adventures" },
      { primary_content: "Things You've Broken" },
      { primary_content: "Pets & Animals" },
      { primary_content: "Your Biggest Accomplishment" },
      { primary_content: "Movies & TV Shows" },
      { primary_content: "Cooking Disasters" },
      { primary_content: "Things You Collect" },
      { primary_content: "First Date Stories" },
      { primary_content: "Your Worst Habit" },
      { primary_content: "Dream Vacations" },
      { primary_content: "Things You've Won" },
      { primary_content: "Unusual Skills" },
      { primary_content: "Books That Changed You" },
      { primary_content: "Your Morning Routine" },
      { primary_content: "Technology Fails" },
      { primary_content: "Fashion Choices" },
      { primary_content: "Superstitions You Have" },
      { primary_content: "Things You've Built" },
      { primary_content: "Languages & Communication" },
      { primary_content: "Your Bucket List" },
      { primary_content: "Holidays & Traditions" },
      { primary_content: "Hobbies Past & Present" },
      { primary_content: "Your Hometown" },
      { primary_content: "Roommate Stories" },
      { primary_content: "Things That Scare You" },
      { primary_content: "Favorite Childhood Toy" },
      { primary_content: "Road Trip Tales" },
      { primary_content: "Your Secret Obsession" },
      { primary_content: "Dance Moves" },
      { primary_content: "Things You've Lost" },
      { primary_content: "Your Weirdest Purchase" },
      { primary_content: "Outdoor Adventures" },
      { primary_content: "Things You Do When Nobody's Watching" },
      { primary_content: "Your Guilty Pleasure" },
      { primary_content: "Nicknames You've Had" },
      { primary_content: "Life-Changing Moments" },
      { primary_content: "Your Biggest Fear" },
      { primary_content: "Something You've Never Told Anyone" },
      { primary_content: "Your Proudest Moment" },
      { primary_content: "The Strangest Thing You've Eaten" },
    ],
  },
];

async function main() {
  console.log("Setting up Pinyata database...\n");
  ...
  for (const game of GAMES) {
    ...
    if (gameError) {
      console.error(`Failed to insert game "${game.title}":`, gameError.message);
      continue;
    }

    console.log(`Inserted game: ${game.title} (${insertedGame.id})`);

    // Delete existing entries for this game (for idempotency)
    await supabase.from("game_entries").delete().eq("game_id", insertedGame.id);

    // Insert entries
    const entriesWithGameId = entries.map((e, i) => ({
      ...e,
    ...
    const { error: entriesError } = await supabase
      .from("game_entries")
      .insert(entriesWithGameId);

    if (entriesError) {
      console.error(`Failed to insert entries for "${game.title}":`, entriesError.message);
    } else {
